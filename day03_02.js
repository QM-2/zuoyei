...
console.log(oSudent1.name);
console.log(typeof oSudent1); //object
...
const avengers = ['美国队长','钢铁侠','黑寡妇','绿巨人']
delete avengers[2];
...
const avengers = ['美国队长','钢铁侠','黑寡妇','绿巨人'];
avengers.unshift("qiumin");
console.log(avengers);

const avengers = ['美国队长','钢铁侠','黑寡妇','绿巨人'];
const heroes = ['蝙蝠侠','神奇女侠','闪电侠'];
...
const avengers = ['美国队长','钢铁侠','黑寡妇','绿巨人'];
const av4 = avengers.splice(1,2,'qiu','min');
console.log(av4);
console.log(avengers)
